...
public class ProxyController {
    ...
    public ResponseEntity<?> filter(HttpServletRequest request, @RequestBody(required = false) String body) throws IOException, URISyntaxException {
        ...
        if(entity != null) responseBody = EntityUtils.toByteArray(entity);
        ...
        if (contentType.startsWith("image/") || contentType.equals("application/octet-stream")) {
            ...
            return handleHtmlResponse(new String(responseBody, StandardCharsets.UTF_8), headers, proxyResponse.getStatusLine().getStatusCode());
        }
    ...
    private ResponseEntity<String> handleHtmlResponse(String responseBody, HttpHeaders headers, int statusCode) {
        responseBody = responseBody.replaceAll("<img class=\"jfN4p\"[^>]*>",
                "<img id=\"dimg_YZ9pZqjaCIvJ1e8PqdP9wAM_29\" src=\"data:image/png;base64,\" class=\"YQ4gaf zr758c wA1Bge\" height=\"56\" width=\"45\" alt=\"\" data-csiid=\"13\" data-atf=\"1\">");
